...
func TestRetrieveDatesHandler(t *testing.T) {

	// Create a new request with a JSON body
	user := User{Name: "lib", Email: "lib@marston", Password: "12345"}
	...
	req, err = http.NewRequest("GET", "/retrieve-dates", nil)
	...
	handler = retrieveDatesHandler(client)
	...
	expected := `{"dates":[{"date":"2023-03-28"},{"date":"2023-03-29"},{"date":"2023-04-15"},{"date":"2023-04-16"},{"date":"2023-04-17"}],"CurrentStreak":13}`
